      ...
      <View className="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm items-center">
        ...
        <View className="w-full border-t border-gray-50 pt-4 mt-2">
          <View className="flex-row justify-between mb-2">
            <Text className="text-textSecondary text-xs">Role Title</Text>
            <Text className="text-textPrimary font-bold text-xs">{profile?.role}</Text>
          </View>
          <View className="flex-row justify-between">
            <Text className="text-textSecondary text-xs">Phone</Text>
